...
This project shows that I can make a basic website based on an html file.

## Technical Achievements
- **Extra Reference links:**: Using a combination of...
- **Typewriter:**: ...

### Design Achievements
- **CSS Stylesheet:** Shown in `style.css`, the code...
